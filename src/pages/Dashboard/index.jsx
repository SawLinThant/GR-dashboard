...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    return(
        ...
        <Sidebar />
        <div className="flex-1 flex-col h-screen ml-[17vw] w-dashboard-main-content overflow-auto pl-5 pr-5 pb-5">
          <div id="progress-bar-contianer" className="w-full h-24 border-b border-gray-500 p-2 bg-gray-100 fixed z-10">
          ...
          <div className="flex-1 mt-[6rem] h-[calc(100% - 6rem)] overflow-y-auto w-full bg-white relative">
            <Routes>
